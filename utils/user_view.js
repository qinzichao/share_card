...
//对外公开的方法
module.exports.updateUserViewAdd = updateUserViewAdd;

//查看更新
function updateUserViewAdd(other_openid, cb) {
  
  //获取应用实例
  var app = getApp();

  var remote_api_url = app.globalData.API_Base_URL + '/user_view_add.php';
